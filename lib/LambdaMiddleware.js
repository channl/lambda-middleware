...
let LambdaMiddleware = class LambdaMiddleware {
  ...
  _getHandler(index) {
    ...
    if (index < this._pipeline.length - 1) {
      ...
      let thisHandler = (() => {
        var _ref2 = _asyncToGenerator(_regeneratorRuntime.mark(function _callee4(ctx) {
        ...
        return function thisHandler(_x2) {
    ...
    let thisHandler = (() => {
      var _ref4 = _asyncToGenerator(_regeneratorRuntime.mark(function _callee6(ctx) {
      ...
      return function thisHandler(_x3) {
